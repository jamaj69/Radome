...
- **Assinatura de emissão:** por ser exclusivamente receptor, o RADOME não gera iluminação nem varredura RF. Comparado a um radar ativo equivalente, possui necessariamente menor detectabilidade por emissão; qualquer energia atribuível à sua presença é espalhamento secundário de sinais externos, não uma transmissão originada pelo nó.
- **Ressalva física:** assinatura de emissão e assinatura de espalhamento são grandezas distintas. Paredes Faraday condutivas, isoladamente, refletem energia; Yagis, boom, juntas e cabos também espalham. A redução adicional de RCS pela geometria e pelo absorvedor deve ser medida nas frequências, polarizações e ângulos de interesse.
...
- **Limite operacional:** a discrição por ausência de emissão própria é uma propriedade da arquitetura. A magnitude da redução da assinatura de espalhamento e qualquer capacidade operacional de defesa aérea permanecem dependentes de ensaio; não se afirma invisibilidade absoluta.
