...
The nominal triangular face uses a 2 m side dimension. The external VHF Yagi is mounted on the outer face through a support/boom axis that continues from the pyramid apex through the sealed face interface. Its parasitic elements are transverse to that axis; the largest transverse element is specified as 2 m. The support transfers mechanical loads to the internal apex and triangular frame. The external antenna is assigned to VHF and is not a universal radiator.
...
A face triangular nominal possui lado de 2 m. A Yagi VHF externa é montada na face externa por um eixo haste/lança que continua do vértice da pirâmide, atravessa a interface vedada e segue para fora. Seus elementos parasitas são transversais a esse eixo; o maior elemento transversal é especificado com 2 m. O suporte transfere as cargas mecânicas para o vértice interno e a moldura triangular. A antena externa é atribuída à faixa VHF e não é um radiador universal.
