...
\caption{Two-metre triangular face with two external crossed VHF Yagis: orthogonal transverse elements, independent feeds and distinct scales.}
\label{fig:face-yagi}
\end{figure}
...
\centering
\includegraphics[width=0.98\textwidth]{fig11_face_yagi_camadas.pdf}
\caption{Face triangular de 2 m com duas Yagis VHF externas cruzadas: elementos transversais ortogonais, alimentações independentes e escalas distintas.}
