...
\caption{Arquitetura distribuída de sensoriamento: o bloco superior representa um iluminador ou emissor externo, os três blocos azuis identificam os Radomes A, B e C, os caminhos verdes transportam observações calibradas e o bloco roxo inferior representa a central de comando responsável pela associação e fusão.}
