...
A interseção probabilística entre elipsoide de atraso, AOA, Doppler/FDOA, potência e polarização válida produz uma região de estado com covariância, e não um ponto exato. Um segundo radome sincronizado acrescenta outro elipsoide e outras restrições angulares; um terceiro nó tende a melhorar observabilidade e rejeição de ambiguidades. A incerteza somente diminui de fato quando há geometria favorável, visibilidade comum, associação correta da mesma reflexão, clocks e atrasos calibrados e modelo de propagação adequado. O demonstrador deve reportar a covariância estimada e confrontá-la com erro observado e GDOP, sem prometer antecipadamente uma incerteza pequena.
