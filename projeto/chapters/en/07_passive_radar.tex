...
The probabilistic intersection of delay ellipsoids, AOA, Doppler/FDOA, power and valid polarization yields a state region with covariance rather than an exact point. A second synchronized radome adds another ellipsoid and further angular constraints; a third node generally improves observability and ambiguity rejection. Uncertainty decreases in practice only with favourable geometry, common visibility, correct association of the same reflection, calibrated clocks/channel delays and an adequate propagation model. The demonstrator must report predicted covariance against observed error and GDOP rather than promise small uncertainty in advance.
