...
\caption{Distributed sensing architecture: the upper block is an external illuminator or emitter, the three blue blocks identify Radomes A, B and C, green paths carry calibrated observations, and the lower purple block is the command center responsible for association and fusion.}
