...
\hypersetup{colorlinks=true,linkcolor=blue!50!black,citecolor=blue!50!black,urlcolor=blue!50!black,pdftitle={RADOME V1 -- Technical Project}}
...
\title{\textbf{RADOME V1}\\[0.5em]\large Distributed Multiband Conformal Radome Network\\Rede Distribuída de Radomes Conformais Multifaixa}
