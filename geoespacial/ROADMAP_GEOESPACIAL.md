...
| MDE nacional | TOPODATA/INPE | augmented_mesh_resilience_analyzed | K3 contém 10,11%/11,43% dos centros em k=1/k=4/3; 129/122 componentes e 47/23 articulações, versus 100% de incidência por discos; paridade candidato--vértice e arestas são validadas | diagnosticar células fora de K3 e gargalos para nova seleção |
