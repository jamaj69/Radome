...
## Corpus Check
- 160 files · ~490,919 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1125 nodes · 1493 edges · 110 communities (90 shown, 20 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 120 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `50b0f649`
...
3. `deterministic_gzip_csv()` - 21 edges
...
## Knowledge Gaps
- **493 isolated node(s):** `run_pipeline.sh script`, `build.sh script`, `Mandatory Startup Context Recovery`, `Graphify`, `Project Layout` (+488 more)
...
- **Why does `evaluate()` connect `evaluate_anatel_radio_link_terrain.py` to `build_canonical_smp.py`?**
