...
## Corpus Check
- 257 files · ~634,097 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1499 nodes · 2040 edges · 148 communities (112 shown, 36 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 161 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f50cba05`
...
- build_canonical_fixed_emitters.py
- validate_anatel_radio_link_geometry.py
- unified_geospatial_graph/README.md
- validate_anatel_radio_link_vertical_geometry.py
...
- build_continental_coverage_grid.py
- topodata_gap_seeds/README.md
- validate_anatel_radio_link_vertical_geometry.py
- topodata_gap_candidates/README.md
- build_continental_coverage_grid.py
- augmented_continental_coverage_grid/README.md
- augmented_triangular_mesh/README.md
...
- render_curved_earth_radomes.py
- build
- blender_topografia_radomes/README.md
- validate_anatel_radio_link_vertical_geometry.py
...
10. `RADOME — Geodetic Multiband Passive Electromagnetic Sensing Network` - 12 edges
...
Cohesion: 0.17
Nodes (11): Camada municipal e integração de emissores, Construção dos candidatos, Fontes e proveniência, Grafo, Hipóteses controladas, Linha experimental: malha triangular cooperativa, Metodologia reproduzível para seleção geoespacial de sítios, Objetivo (+3 more)
...
Cohesion: 0.20
Nodes (9): Cidades, municípios e logística, Decisões operacionais derivadas, Escopo territorial, Grafo de infraestrutura e iluminadores, Heurística alternativa de malha triangular, Objetivo primário, Relevo, visada e conectividade, Reprodutibilidade e publicação (+1 more)
...
Cohesion: 0.22
Nodes (8): Comando de retomada, Dados e integrações concluídos, Estado atual do subprojeto geoespacial, Lacunas controladas, Próxima ação executável, Validação reproduzível, Vinculação e governança, Visualização Blender experimental

### Community 76 - "build_municipal_emitter_network.py"
Cohesion: 0.13
Nodes (15): acquire_archive(), acquire_selection(), atomic_json(), main(), Path, Valida estrutura, CRC e presenca do GeoTIFF de altitude., Reutiliza um ZIP valido ou o baixa para arquivo temporario atomico., sha256_file() (+7 more)
...
Cohesion: 0.30
Nodes (11): add_candidate_layer(), add_hypothesis_layer(), add_membership_layer(), add_node(), build(), main(), node_type(), Graph (+3 more)
...
Cohesion: 0.33
Nodes (3): Apendice A - Formato minimo de registro de deteccao, Apendice B - Equacoes de referencia, Referencias

### Community 101 - "Key Technical Themes"
Cohesion: 0.33
...
Cohesion: 0.14
Nodes (19): analyse(), azimuth_sector(), deduplicate(), distance_km(), main(), normalize(), open_layer(), Point (+11 more)
...
Cohesion: 0.07
Nodes (28): build(), face_status(), lambert_azimuthal_equal_area(), main(), Path, read_grid(), triangle_quality(), build() (+20 more)
...
### Community 110 - "validate_anatel_radio_link_vertical_geometry.py"
Cohesion: 0.25
Nodes (9): generate(), intersecting(), load_tiles(), main(), pixel_window(), Path, Retorna janela semiaberta de pixels cujos centros caem dentro da célula., seed_cell() (+1 more)
...
### Community 114 - "extract_anatel_radio_links.py"
Cohesion: 0.33
...
### Community 120 - "validate_anatel_radio_link_vertical_geometry.py"
Cohesion: 0.50
...
### Community 126 - "augmented_mesh_topodata_tiles/README.md"
Cohesion: 0.50
...
Cohesion: 0.08
Nodes (27): build(), covering_tile(), Mosaica amostras TOPODATA para uma superfície regional Blender.  Não produz uma, Abre uma vez as folhas e registra suas extensões geográficas., Lê blocos por folha, evitando uma chamada GDAL por vértice., sample_grid(), tile_catalog(), build() (+19 more)
...
Cohesion: 0.06
Nodes (52): available_window_size(), build(), hillshade_path(), Exporta grades TOPODATA para malhas Blender com uma cota por vértice., Abre a folha que contém a coordenada geográfica solicitada., Maior janela quadrada ímpar, centrada, que permanece na mesma folha., terrain_color(), tile_for() (+44 more)
...
### Community 141 - "select_topodata_gap_tiles.py"
Cohesion: 0.25
...
### Community 146 - "validate_anatel_radio_link_vertical_geometry.py"
Cohesion: 0.23
...
- **Why does `requirements()` connect `build_augmented_candidate_graph.py` to `select_topodata_route_tiles.py`?**
