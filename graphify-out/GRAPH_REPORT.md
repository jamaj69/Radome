...
## Corpus Check
- 31 files · ~543,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 563 nodes · 593 edges · 46 communities (41 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `601426f2`
...
3. `RADOME — Registro de decisões de arquitetura` - 17 edges
...
## Knowledge Gaps
- **390 isolated node(s):** `build.sh script`, `Mandatory Startup Context Recovery`, `Graphify`, `Project Layout`, `LaTeX Article Commands` (+385 more)
