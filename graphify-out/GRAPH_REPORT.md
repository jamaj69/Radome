...
## Corpus Check
- 31 files · ~543,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 562 nodes · 592 edges · 53 communities (48 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `13c16db6`
...
3. `RADOME — Registro de decisões de arquitetura` - 16 edges
...
## Knowledge Gaps
- **389 isolated node(s):** `build.sh script`, `Mandatory Startup Context Recovery`, `Graphify`, `Project Layout`, `LaTeX Article Commands` (+384 more)
